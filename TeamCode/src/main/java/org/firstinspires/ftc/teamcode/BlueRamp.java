...
@Autonomous(name="Blue Ramp Only", group="Official")  // @TeleOp(...) is the other common choice
//@Disabled
...
public class BlueRamp extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            //Turns 90 degrees
            driveDistance(leftMotor, 0.30, 1.7 * Feet * mmPerInch);
            ...
            //<editor-fold desc="The rest of the code applies to BlueBeacon Only!">

            /*

            //Drive back for 2.2 feet
            driveDistance(leftMotor, 0.20, -2.2 * Feet * mmPerInch);
            driveDistance(rightMotor, 0.20, -2.2 * Feet * mmPerInch);
            ...
            //Turn 90 degrees, to get lined up in order to drive to the wall
            ...
            driveDistance(rightMotor, 0.30, 0.4 * Feet * mmPerInch);
            driveDistance(leftMotor, 0.30, -0.4 * Feet * mmPerInch);
            while (Math.abs(rightMotor.getTargetPosition() - rightMotor.getCurrentPosition()) > 50 || Math.abs(leftMotor.getTargetPosition() - leftMotor.getCurrentPosition()) > 50) {
                telemetry.addData("Mode", "Turning...");
                telemetry.addData("Target Pos", "R%d L%d", rightMotor.getTargetPosition(), leftMotor.getTargetPosition());
                telemetry.addData("Current Pos", "R%d L%d", rightMotor.getCurrentPosition(), leftMotor.getCurrentPosition());
